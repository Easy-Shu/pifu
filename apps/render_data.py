...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, default='./data/rp_dennis_posed_004_OBJ')
    parser.add_argument('-o', '--out_dir', type=str, default='./data/train')
    ...
    parser.add_argument('-e', '--egl', action='store_true', default=True,
